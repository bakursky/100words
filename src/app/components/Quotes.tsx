...
export default function Quotes() {
    ...
    return (
        <div className='component-bg p-6  px-12 text-neutral-500 italic text-lg flex flex-col items-center text-center gap-2 mb-24 '>
            <div>{quotes[randomNumber].quote}</div>
            <span className='text-sm text-neutral-300 mt-2'>{quotes[randomNumber].author}</span>
        </div>
    )
}