...
export default function Streaks() {
    ...
    return (
        <div className='w-96 mx-auto'>
            ...
            <div className='flex flex-col w-full text-4xl mb-4 font-black text-neutral-600'>
                <span className='text-base font-normal text-neutral-300 uppercase tracking-wider'>Today</span> {today}
            </div>
            ...
            <div className='flex gap-2 items-start justify-between font-semibold text-md text-neutral-500'>
                ...
                {dayOfWeeks.map((item, index) => {
                    const style = 'w-10 h-10  flex items-center justify-center bg-[#121212] rounded-full'
                    const today = 'w-10 h-10  border-2 border-neutral-600 bg-[#121212] rounded-full flex items-center justify-center'
