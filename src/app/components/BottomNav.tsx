  ...
  return (
    <div className="text-xs">
      <div className="flex items-center justify-center gap-4 p-4 h-[60px] w-full bottom-0 fixed bg-[#1c1c1c] shadow-[0px_-15px_15px_0px_rgba(0,_0,_0,_0.1)] text-white/35 z-30 " >
        ...
        <div >
          {/* <RedButton /> */}
          <button onClick={() => setNewEntryOpen(true)} className="flex w-[65px] h-[65px] rounded-full bg-purple-700 shadow-lg items-center justify-center mb-8 text-xl font-bold text-white/70 hover:scale-90 transition-all">
