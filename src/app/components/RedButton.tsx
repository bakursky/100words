...
export default function RedButton() {
    ...
    const buttonColor = () => {
        const baseStyle = 'flex w-[65px] h-[65px] rounded-full items-center justify-center mb-8 text-xl font-bold shadow-lg shadow-neutral-900 cursor-not-allowed'
        return wordCounter() < 100 ? baseStyle + ' component-bg text-white/40' : baseStyle + 'cursor-default bg-neutral-300 text-neutral-900 transition-all'
    }
