...
export default function Settings() {
    ...
    return (
        <div className='max-w-md mx-auto px-6 mt-6 mb-20'>
            ...
            <div className="flex flex-col items-center w-full component-bg">
                <Image
            ...
            <button className="m-2 rounded-[40px]  border-2 border-purple-700 p-3 text-white hover:scale-95 transition-all" onClick={paywallToggle}>PRO features:{paywallValue === 1 ? "On" : "Off"}</button>
            </div>
