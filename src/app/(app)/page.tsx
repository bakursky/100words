...
export default function Home() {
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-4 w-full text-neutral-500 font-semibold">
                <div className="component-bg p-6 w-full flex flex-col">
                    <div className='flex gap-1'>
                        ...
                        Current streak</div>
                    <p className="text-xl font-bold text-neutral-300 w-full">{streaks?.current_streak}&nbsp;days</p>
                </div>
                ...
                <div className="component-bg p-6 w-full flex flex-col">
                    <div className='flex gap-2'>
                        ...
                        Max streak</div>
                    <p className="text-xl font-bold text-neutral-300 w-full">{streaks?.max_streak}&nbsp;days</p>
                </div>
                ...
                <div>
                    <div className='flex-col w-96 component-bg p-6'>
                        <div className='flex gap-1'>
                            ...
                            <div className='text-neutral-500 font-semibold'>Today&apos;s note</div>
                        </div>
