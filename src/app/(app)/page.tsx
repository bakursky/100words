        ...
        >
            ...
            <div className="flex gap-4 w-full text-neutral-500 ">
                <div className="component-bg p-6 w-full flex flex-col">
                    <div className='flex gap-1'>
                        ...
                        Current streak</div>
                    <p className="text-2xl font-bold text-neutral-300 w-full">{streaks?.current_streak}&nbsp;days</p>
                </div>
                ...
                <div className="component-bg p-6 w-full flex flex-col">
                    <div className='flex gap-2'>
                        ...
                        Max streak</div>
                    <p className="text-2xl font-bold text-neutral-300 w-full">{streaks?.max_streak}&nbsp;days</p>
                </div>
            ...
            {isLoadingNotes ? (
                <div className='flex-col w-96 component-bg p-6'>
                    <div className='text-neutral-600 font-semibold'>Loading...</div>
                </div>
                ...
                <div>
                    <div className='flex-col w-96 component-bg p-6'>
                        <div className='flex gap-1 text-neutral-500'>
                            ...
                            <div className=''>Today&apos;s note</div>
                        </div>
                    ...
                    <TodayEntryAiRecap />
                    <WeeklyAiRecap />
                    {/* {weekTimer.hours < 0 ? (<WeeklyAiRecap />) : (
                        <div className='rounded-[40px] bg-gradient-to-tr from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% p-1 mt-4'>
                            <div className="flex gap-8 component-bg p-6 ">
                                ...
                                <div className='text-white/30'> Will appear after {weekTimer.days} days</div>
                ...
                <div className=''>
                    <button className='flex-col w-96 component-bg p-4' onClick={() => setNewEntryOpen(true)}>
                        ...
                        <div className='mt-4 text-neutral-500 text-center'>You have <p className='inline-block text-neutral-300 text-lg'>{timer.hours}h {timer.minutes}min</p> to write 100 words</div>
                        <div className='mt-4 bg-stone-300 shadow-lg hover:scale-95 transition-all rounded-full p-2 font-semibold text-black'>+ New entry</div>
                    </button>
                </div>
            )}
